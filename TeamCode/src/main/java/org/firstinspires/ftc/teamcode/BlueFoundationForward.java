...
//12/15/2020
// Code title: BlueFoundationForward
// Description: drags foundation to building site and parks0 under bridge in "forward position" (next to neutral bridge)
...
@Autonomous(name="BlueFoundationForward", group="Linear Opmode")
//@Disabled
public class BlueFoundationForward extends LinearOpMode {
