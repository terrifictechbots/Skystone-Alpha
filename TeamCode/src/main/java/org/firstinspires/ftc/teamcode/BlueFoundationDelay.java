...
//12/15/2020
// Code title: BlueFoundationDelay
// Description: 15 second delay to allow alliance to drop a block, then drags foundation to building site and parks under the bridge
...
@Autonomous(name="BlueFoundationDelay", group="Linear Opmode")

public class BlueFoundationDelay extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(200);
        //move foundation back to building site
