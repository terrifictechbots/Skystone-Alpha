...
//12/15/2020
// Code title: BlueFoundationDelayForward
// Description: 15 second delay to allow alliance to drop a block, drags foundation to building site and parks0 under bridge in "forward position" (next to neutral bridge)
...
@Autonomous(name="BlueFoundationDelayForward", group="Linear Opmode")

public class BlueFoundationDelayForward extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Terry.servoHand.setPosition(0.5);
        ...
        sleep(200);
        //slide out from behind foundation
        encoderDrive(SLIDEL_SPEED, -34, 34, 34, -34);
        //move hand to "closed" position
        Terry.servoHand.setPosition(0);
        //drive forward so that robot is next to foundation
        encoderDrive(DRIVE_SPEED, -22,-22,-22,-22);
        //bump foundation so that it is further into building site
        encoderDrive(SLIDER_SPEED,11,-11,-11,11);
        //park under bridge in "forward position" (next to neutral bridge)
        encoderDrive(SLIDEL_SPEED,-17,17,17,-17);
